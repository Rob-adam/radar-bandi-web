...
def generic_region_items(html, base, source_name, territory):
    ...
    Accetta solo schede che, nel testo visibile della pagina elenco, mostrano
    contemporaneamente segnali di bando e segnali ETS/non profit. In questo modo
    allarghiamo la copertura senza riempire il catalogo di gare o avvisi irrilevanti.
    """
    soup = BeautifulSoup(html, "html.parser")
    out = []
    seen = set()
